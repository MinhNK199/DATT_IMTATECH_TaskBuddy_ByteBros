      ...
      <div className="w-full max-w-4xl flex bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12">
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-500">Join TaskBuddy to get started managing your tasks</p>
          </div>
        ...
        <div className="hidden md:block w-1/2 bg-gradient-to-br from-purple-600 to-indigo-700 p-12 text-white">
          <div className="h-full flex flex-col justify-between">
            <div>
              ...
              <p className="text-indigo-100">Create your TaskBuddy account and start organizing your tasks efficiently.</p>
            </div>
            ...
            <div className="mt-auto">
              <div className="bg-white/10 rounded-lg p-6">
                ...
                <blockquote className="text-sm italic">
                  "TaskBuddy has completely transformed how I organize my work. The interface is intuitive, and I love how it helps me prioritize my tasks!"
                </blockquote>
              </div>
            </div>
          </div>
