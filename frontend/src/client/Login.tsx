        ...
        <div className="hidden md:block w-1/2 bg-gradient-to-br from-indigo-600 to-purple-700 p-12 text-white">
          <div className="h-full flex flex-col justify-between">
            <div>
              ...
              <p className="text-indigo-100">Log in to your account to manage your tasks, track your progress, and achieve your goals.</p>
            </div>
            ...
            <div className="mt-auto">
              <div className="flex flex-col space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span>Task organization made simple</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="bg-white/20 rounded-full p-1">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
